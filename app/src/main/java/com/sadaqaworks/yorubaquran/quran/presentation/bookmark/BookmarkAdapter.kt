...
class BookmarkAdapter(val onBookmarkClick:(Int) -> Unit =  {}) : RecyclerView.Adapter<BookmarkAdapter.BookmarkViewHolder>() {
    ...
    override fun onBindViewHolder(holder: BookmarkViewHolder, position: Int) {
        ...
        holder.bookmarkIcon.setOnClickListener {
            val selectedAyah = bookmark.id
            onBookmarkClick(selectedAyah)
    ...
    fun setBookmark(bookmarks: List<Bookmark>){
        this.bookmarks = bookmarks
        notifyDataSetChanged()
    }

    private fun bindBookmark(bookmark: Bookmark, holder:BookmarkViewHolder){
